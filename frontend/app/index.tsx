...
const styles = StyleSheet.create({
  ...
  logoCircle: { width: 110, height: 110, borderRadius: 55, overflow: 'hidden', backgroundColor: '#000000', borderWidth: 2, borderColor: 'rgba(59,155,245,0.3)' },
  logoImage: { width: 106, height: 106 },
  brandRow: { flexDirection: 'row', alignItems: 'baseline', marginTop: 14 },
  brandBill: { fontSize: 30, fontWeight: '800', color: '#3B9BF5' },
  brandBrain: { fontSize: 30, fontWeight: '800', color: '#8BA3B8' },
  tagline: { fontSize: 12, color: Colors.dark.textTertiary, marginTop: 6, letterSpacing: 1.5, textTransform: 'uppercase' },
