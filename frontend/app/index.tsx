...
const styles = StyleSheet.create({
  ...
  brandRow: { flexDirection: 'row', alignItems: 'baseline', marginTop: 10 },
  brandBill: { fontSize: 28, fontWeight: '800', color: '#1AC9FF' },
  brandBrain: { fontSize: 28, fontWeight: '800', color: '#B0C4D8' },
  tagline: { fontSize: 13, color: Colors.dark.textSecondary, marginTop: 6, letterSpacing: 1.5, textTransform: 'uppercase' },
